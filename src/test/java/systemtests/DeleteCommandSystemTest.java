...
public class DeleteCommandSystemTest extends ParticipantAddressBookSystemTest {
     ...
     * {@code ParticipantAddressBookSystemTest#assertApplicationDisplaysExpected(String, String, Model)}.
