...
public class ModelManagerTest {
    ...
    public void constructor() {
        ...
        assertEquals(new ParticipantAddressBook(), new ParticipantAddressBook(modelManager.getAddressBook()));
    ...
    public void setUserPrefs_validUserPrefs_copiesUserPrefs() {
        ...
        userPrefs.setParticipantFilePath(Paths.get("address/book/file/path"));
        ...
        userPrefs.setParticipantFilePath(Paths.get("new/address/book/file/path"));
    ...
    public void equals() {
        ...
        modelManager = new ModelManager(participantAddressBook, userPrefs);
        ModelManager modelManagerCopy = new ModelManager(participantAddressBook, userPrefs);
        ...
        // different participantAddressBook -> returns false
        assertFalse(modelManager.equals(new ModelManager(differentParticipantAddressBook, userPrefs)));

        // different filteredList -> returns false
        String[] keywords = ALICE.getName().fullName.split("\\s+");
        modelManager.updateFilteredPersonList(new NameContainsKeywordsPredicate(Arrays.asList(keywords)));
        assertFalse(modelManager.equals(new ModelManager(participantAddressBook, userPrefs)));
        ...
        differentUserPrefs.setParticipantFilePath(Paths.get("differentFilePath"));
        assertFalse(modelManager.equals(new ModelManager(participantAddressBook, differentUserPrefs)));
    }
}
