...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            .withSex("F").withBirthday("07081994").withMajor("123, Jurong West Ave 6, #08-111")
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withSex("M").withBirthday("01023456")
            .withPhone("95352563").withEmail("heinz@example.com").withMajor("wall street").withGroup("").build();
    ...
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withSex("F").withBirthday("01023456").withMajor("little india")
            .withGroup("").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withEmail("hans@example.com").withSex("F").withBirthday("01023456").withMajor("chicago ave")
            .withGroup("").build();
