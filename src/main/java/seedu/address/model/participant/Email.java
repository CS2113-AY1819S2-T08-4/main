...
/**
 * Represents a Participant's email in the address book.
...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Emails should be of the format local-part@domain.tld "
            ...
            + "3. Finally, it is followed by a '.' and then a TLD (Top Level Domain) \n"
            + "    - be at least 2 characters long\n"
    ...
    private static final String TOP_LEVEL_DOMAIN_REGEX = "[a-zA-Z]{2,}$";
